      ...
      <main>
        ...
        <section className="border-y border-foundri-border bg-foundri-deep px-6 py-16">
          <div className="mx-auto grid max-w-4xl gap-8 text-center sm:grid-cols-3">
            ...
            <div>
              <p className="font-[family-name:var(--font-display)] text-4xl font-bold text-foundri-yellow">100%</p>
              <p className="mt-2 text-sm text-foundri-muted">Overzicht — altijd weten hoe je bedrijf ervoor staat</p>
            </div>
            <div>
        ...
        {/* Pricing */}
        <section className="border-t border-foundri-border px-6 py-24">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              ...
              <div className="rounded-lg border border-white/10 bg-foundri-deep p-6">
                <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-white">Free</h3>
                <p className="mt-1 text-3xl font-bold text-white">€0<span className="text-sm font-normal text-foundri-muted">/maand</span></p>
                <p className="mt-3 text-sm text-foundri-muted">Alles wat je nodig hebt om te starten.</p>
              ...
              {/* Pro */}
              <div className="rounded-lg border-2 border-foundri-yellow bg-foundri-deep p-6 relative">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-foundri-yellow px-3 py-0.5 text-xs font-bold text-foundri-graphite">
                  Populair
                </div>
      ...
      <footer className="border-t border-foundri-border px-6 py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-6 text-sm text-foundri-muted">
            ...
            <a href="mailto:info@foundrios.app" className="hover:text-white transition-colors">Contact</a>
          </div>
          <p className="text-sm text-foundri-muted">
            &copy; {new Date().getFullYear()} FoundriOS
          </p>
        </div>
      </footer>
    </div>
